...
function module_catalog(): array
{
    return [
        ...
        'attendance_payroll' => ['label' => 'Attendance Payroll Rules', 'icon' => 'bi-clock-history', 'url' => 'attendance-payroll/index', 'section' => 'Leave & Attendance', 'routes' => ['attendance-payroll']],
